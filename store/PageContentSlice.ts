...
const initialState: initialStateInterface = {
  AllContent:
    [{ id: '1', selectpImg: Comand1, numberOfImages: 15, header: 'Команда', dir: 'Comand', content: 'Lorem Lorem Lorem Lorem LoremLorem Lorem Lorem Lorem', img: Comand, imagetitle: 'From Nature to Culture' },
    ...
    { id: '6', selectpImg: Yana1, numberOfImages: 15, header: 'Яна Суетнова', dir: 'Yana', content: 'Lorem Lorem Lorem Lorem LoremLorem Lorem Lorem Lorem', img: Yana, imagetitle: 'Reventing Wonder' },
    { id: '7', selectpImg: FS1, numberOfImages: 15, header: 'Людмила Бухова', dir: 'FS', content: 'Lorem Lorem Lorem Lorem LoremLorem Lorem Lorem Lorem', img: FS, imagetitle: 'Sound Expressed In Enpty' }
